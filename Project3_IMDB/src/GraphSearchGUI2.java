...
public class GraphSearchGUI2 extends Application {
	...
	public void start (Stage primaryStage) {
		...
		final Graph graph;
		try {
			graph = new IMDBActorsGraph("actresses_first_10000_lines2.list", "actors_first_10000_lines2.list");
